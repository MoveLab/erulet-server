...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Box.last_modified'
        db.add_column(u'appulet_box', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Box.created'
        db.add_column(u'appulet_box', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Route.last_modified'
        db.add_column(u'appulet_route', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Route.created'
        db.add_column(u'appulet_route', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'InteractiveImage.last_modified'
        db.add_column(u'appulet_interactiveimage', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'InteractiveImage.created'
        db.add_column(u'appulet_interactiveimage', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Rating.last_modified'
        db.add_column(u'appulet_rating', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Rating.created'
        db.add_column(u'appulet_rating', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Highlight.last_modified'
        db.add_column(u'appulet_highlight', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Highlight.created'
        db.add_column(u'appulet_highlight', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Step.last_modified'
        db.add_column(u'appulet_step', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Step.created'
        db.add_column(u'appulet_step', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Reference.last_modified'
        db.add_column(u'appulet_reference', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Reference.created'
        db.add_column(u'appulet_reference', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Track.last_modified'
        db.add_column(u'appulet_track', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Track.created'
        db.add_column(u'appulet_track', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Box.last_modified'
        db.delete_column(u'appulet_box', 'last_modified')

        # Deleting field 'Box.created'
        db.delete_column(u'appulet_box', 'created')

        # Deleting field 'Route.last_modified'
        db.delete_column(u'appulet_route', 'last_modified')

        # Deleting field 'Route.created'
        db.delete_column(u'appulet_route', 'created')

        # Deleting field 'InteractiveImage.last_modified'
        db.delete_column(u'appulet_interactiveimage', 'last_modified')

        # Deleting field 'InteractiveImage.created'
        db.delete_column(u'appulet_interactiveimage', 'created')

        # Deleting field 'Rating.last_modified'
        db.delete_column(u'appulet_rating', 'last_modified')

        # Deleting field 'Rating.created'
        db.delete_column(u'appulet_rating', 'created')

        # Deleting field 'Highlight.last_modified'
        db.delete_column(u'appulet_highlight', 'last_modified')

        # Deleting field 'Highlight.created'
        db.delete_column(u'appulet_highlight', 'created')

        # Deleting field 'Step.last_modified'
        db.delete_column(u'appulet_step', 'last_modified')

        # Deleting field 'Step.created'
        db.delete_column(u'appulet_step', 'created')

        # Deleting field 'Reference.last_modified'
        db.delete_column(u'appulet_reference', 'last_modified')

        # Deleting field 'Reference.created'
        db.delete_column(u'appulet_reference', 'created')

        # Deleting field 'Track.last_modified'
        db.delete_column(u'appulet_track', 'last_modified')

        # Deleting field 'Track.created'
        db.delete_column(u'appulet_track', 'created')


    models = {
        u'appulet.box': {
            'Meta': {'object_name': 'Box'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
