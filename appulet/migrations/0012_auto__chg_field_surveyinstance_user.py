...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'appulet_surveyinstance', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SurveyInstance.user'
        raise RuntimeError("Cannot reverse this migration. 'SurveyInstance.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SurveyInstance.user'
        db.alter_column(u'appulet_surveyinstance', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'appulet.surveyinstance': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'surveys_instances'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
