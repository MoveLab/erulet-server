...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Highlight.id_on_creator_device'
        db.add_column(u'appulet_highlight', 'id_on_creator_device',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SurveyResponse.integer_response'
        db.add_column(u'appulet_surveyresponse', 'integer_response',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Highlight.id_on_creator_device'
        db.delete_column(u'appulet_highlight', 'id_on_creator_device')

        # Deleting field 'SurveyResponse.integer_response'
        db.delete_column(u'appulet_surveyresponse', 'integer_response')


    models = {
        u'appulet.box': {
            'Meta': {'object_name': 'Box'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'appulet.highlight': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_on_creator_device': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'appulet.rating': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 0, 0)', 'blank': 'True'}),
        ...
        u'appulet.route': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_route_based_on': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'related_routes'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['appulet.Route']"}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'name_ca': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'name_es': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            ...
            'track': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'route'", 'unique': 'True', 'null': 'True', 'to': u"orm['appulet.Track']"}),
        ...
        u'appulet.surveyresponse': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'integer_response': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 23, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
