...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RouteTranslationVCS'
        db.create_table(u'appulet_routetranslationvcs', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('route', self.gf('django.db.models.fields.related.ForeignKey')(related_name='route_translation_vcs_entries', to=orm['appulet.Route'])),
        ...
        db.send_create_signal(u'appulet', ['RouteTranslationVCS'])


    def backwards(self, orm):
        # Deleting model 'RouteTranslationVCS'
        db.delete_table(u'appulet_routetranslationvcs')
