...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'appulet_reference', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='unnamed reference', max_length=200)),
        ...
        db.create_table(u'appulet_route', (
            ...
            ('short_description', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ...
        db.create_table(u'appulet_highlight', (
            ...
            ('long_text', self.gf('django.db.models.fields.CharField')(max_length=2000, blank=True)),
    ...
    models = {
        ...
        u'appulet.highlight': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'long_text': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'blank': 'True'}),
        ...
        u'appulet.reference': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'unnamed reference'", 'max_length': '200'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'})
        },
