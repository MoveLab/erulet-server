...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Route.display_order'
        db.add_column(u'appulet_route', 'display_order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Route.display_order'
        db.delete_column(u'appulet_route', 'display_order')


    models = {
        u'appulet.box': {
            'Meta': {'object_name': 'Box'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 1, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'appulet.rating': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 1, 0, 0)', 'blank': 'True'}),
