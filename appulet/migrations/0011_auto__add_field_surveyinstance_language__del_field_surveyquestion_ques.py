...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyInstance.language'
        db.add_column(u'appulet_surveyinstance', 'language',
                      self.gf('django.db.models.fields.CharField')(default='oc', max_length=2),
                      keep_default=False)

        # Deleting field 'SurveyQuestion.question'
        db.delete_column(u'appulet_surveyquestion', 'question')

        # Adding field 'SurveyQuestion.question_oc'
        db.add_column(u'appulet_surveyquestion', 'question_oc',
                      self.gf('django.db.models.fields.CharField')(default='q', max_length=1000),
                      keep_default=False)

        # Adding field 'SurveyQuestion.question_es'
        db.add_column(u'appulet_surveyquestion', 'question_es',
                      self.gf('django.db.models.fields.CharField')(default='q', max_length=1000),
                      keep_default=False)

        # Adding field 'SurveyQuestion.question_ca'
        db.add_column(u'appulet_surveyquestion', 'question_ca',
                      self.gf('django.db.models.fields.CharField')(default='q', max_length=1000),
                      keep_default=False)

        # Adding field 'SurveyQuestion.question_fr'
        db.add_column(u'appulet_surveyquestion', 'question_fr',
                      self.gf('django.db.models.fields.CharField')(default='q', max_length=1000),
                      keep_default=False)

        # Adding field 'SurveyQuestion.question_en'
        db.add_column(u'appulet_surveyquestion', 'question_en',
                      self.gf('django.db.models.fields.CharField')(default='q', max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyInstance.language'
        db.delete_column(u'appulet_surveyinstance', 'language')

        # Adding field 'SurveyQuestion.question'
        db.add_column(u'appulet_surveyquestion', 'question',
                      self.gf('django.db.models.fields.CharField')(default='q', max_length=1000),
                      keep_default=False)

        # Deleting field 'SurveyQuestion.question_oc'
        db.delete_column(u'appulet_surveyquestion', 'question_oc')

        # Deleting field 'SurveyQuestion.question_es'
        db.delete_column(u'appulet_surveyquestion', 'question_es')

        # Deleting field 'SurveyQuestion.question_ca'
        db.delete_column(u'appulet_surveyquestion', 'question_ca')

        # Deleting field 'SurveyQuestion.question_fr'
        db.delete_column(u'appulet_surveyquestion', 'question_fr')

        # Deleting field 'SurveyQuestion.question_en'
        db.delete_column(u'appulet_surveyquestion', 'question_en')
