...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Map'
        db.create_table(u'appulet_map', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='maps', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('route', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['appulet.Route'], unique=True, null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
            ('map_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 12, 0, 0), auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 12, 0, 0), auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'appulet', ['Map'])


    def backwards(self, orm):
        # Deleting model 'Map'
        db.delete_table(u'appulet_map')


    models = {
        u'appulet.box': {
            'Meta': {'object_name': 'Box'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 12, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'appulet.map': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 12, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'maps'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
