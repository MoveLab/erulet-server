...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Route.reference'
        db.alter_column(u'appulet_route', 'reference_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['appulet.Reference'], unique=True, null=True, on_delete=models.SET_NULL))

        # Changing field 'Highlight.created_by'
        db.alter_column(u'appulet_highlight', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))
        # Adding field 'Reference.general'
        db.add_column(u'appulet_reference', 'general',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Route.reference'
        db.alter_column(u'appulet_route', 'reference_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['appulet.Reference'], unique=True, null=True))

        # Changing field 'Highlight.created_by'
        db.alter_column(u'appulet_highlight', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
        # Deleting field 'Reference.general'
        db.delete_column(u'appulet_reference', 'general')
    ...
    models = {
        ...
        u'appulet.reference': {
            ...
            'general': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
