...
urlpatterns += i18n_patterns('',
    ...
    url(r'^survey_submitted/mob/(?P<response_code>\w+)/$', show_survey_submitted, name='show_survey_submitted_mob'),
    url(r'^survey_results/$', show_survey_results, name='show_survey_results'),
   ...
   url(r'^translate_highlights/(?P<lang>\w+)/(?P<scroll_position>[0-9]+)/$', translate_highlights, name='translate_highlights_scroll_position'),
    url(r'^translate_routes/$', translate_routes),
    url(r'^translate_routes/(?P<lang>\w+)/$', translate_routes, name='translate_routes'),
    url(r'^translate_routes/(?P<lang>\w+)/(?P<scroll_position>[0-9]+)/$', translate_routes, name='translate_routes_scroll_position'),
    ...
    url(r'^delete_highlight_media/(?P<route_id>[0-9]+)/(?P<highlight_id>[0-9]+)/$', delete_highlight_media, name='delete_highlight_media'),
    ...
    url(r'^register/mob/$', RegisterFromAppNew.as_view(), name='auth_register_mob_new'),
